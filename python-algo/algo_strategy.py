...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def attack_strategy(self, game_state):
        ...
        elif game_state.get_resource(MP) >= 13 + game_state.turn_number * 0.1:    # only attack if we meet threshold MP
    ...
    def defense_strategy(self, game_state):
        ...
        right_turret_points = [[25, 13], [26, 13], [23, 12], [24, 12], [25, 12], [25, 11], [20, 10], [21, 10], [20, 9], [22, 10]]
        right_wall_points = [[23, 13], [24, 13], [27, 13], [26, 12], [20, 11], [21, 11], [19, 10]]
        right_support_points = [[21, 9], [20, 8], [18, 7], [17,6], [16, 5], [15, 4]]
        ...
        game_state.attempt_upgrade(right_turret_points[0:2])
        game_state.attempt_upgrade(left_turret_points[0:2])
        ...
        for location in reversed([x for x in game_state.game_map]):
            if game_state.get_resource(SP) < 5:     # save some SP in the bank
                break
            for unit in game_state.game_map[location]:
