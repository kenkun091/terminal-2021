...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def attack_strategy(self, game_state):
        ...
        # elif game_state.get_resource(MP) >= 14 + game_state.turn_number * 0.1:    # only attack if we meet threshold MP
        ...
        #     game_state.attempt_spawn(SCOUT, loc_scout, 1000)
    ...
    def defense_strategy(self, game_state):
        if game_state.turn_number == 0:
            turrets_turn_1 = [[2, 12], [25, 12], [6, 9], [14, 9], [21, 9]]
            walls_turn_1 = [[0, 13], [1, 13], [2, 13], [25, 13], [26, 13], [27, 13], [3, 12], [24, 12], [2, 11], [3, 11], [4, 11], [5, 11], [6, 11], [7, 11], [8, 11], [9, 11], [10, 11], [11, 11], [12, 11], [23, 11]]
            game_state.attempt_spawn(TURRET, turrets_turn_1)
            game_state.attempt_spawn(WALL, walls_turn_1)

        if game_state.turn_number == 1:
            remove_turn_2 = [[2, 11], [3, 11], [5, 11], [6, 11], [7, 11], [8, 11], [9, 11], [10, 11], [11, 11], [12, 11], [6, 9], [14, 9], [21, 9]]
            game_state.attempt_remove(remove_turn_2)
        
        early_game_walls = [[0, 13], [1, 13], [2, 13], [3, 13], [4, 13], [5, 13], [6, 13], [7, 13], [8, 13], [9, 13], [10, 13], [11, 13], [12, 13], [13, 13], [14, 13], [15, 13], [16, 13], [17, 13], [18, 13], [19, 13], [20, 13], [24, 13], [25, 13], [26, 13], [27, 13], [3, 12], [24, 12], [4, 11], [23, 11]]
        early_game_turrets = [[2, 12], [25, 12], [13, 11], [6, 11], [20, 11], [9, 11], [18, 11]]
        if game_state.turn_number < 8:
            game_state.attempt_spawn(WALL, early_game_walls)
            game_state.attempt_spawn(TURRET, early_game_turrets)

            # upgrade corner wall and some turrets
            game_state.attempt_upgrade([[1, 13], [26, 13]])
            game_state.attempt_upgrade(early_game_turrets)

        final_turrets = [[0, 13], [1, 13], [1, 12], [2, 12], [3, 12], [25, 12], [6, 11], [9, 11], [13, 11], [18, 11], [20, 11]]
        final_walls = [[2, 13], [3, 13], [4, 13], [5, 13], [6, 13], [7, 13], [8, 13], [9, 13], [10, 13], [11, 13], [12, 13], [13, 13], [14, 13], [15, 13], [16, 13], [17, 13], [18, 13], [19, 13], [20, 13], [24, 13], [25, 13], [26, 13], [27, 13], [24, 12], [4, 11], [21, 11], [22, 11], [23, 11]]
        final_supports = [[6, 10], [9, 10], [11, 10], [13, 10], [15, 10]]
        if game_state.turn_number == 8:
            game_state.attempt_remove([[0, 13], [1, 13]])
            game_state.attempt_spawn(TURRET, final_turrets)
